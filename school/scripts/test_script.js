...
function goToTeacher(id){
    document.location.href = "teacher_item.html";
    ...
    var requestGroup = new XMLHttpRequest;
        ...
        requestGroup.addEventListener('readystatechange', function() {
            if ((requestGroup.readyState == 4) && (requestGroup.status == 200)) {
                ...
                let teacher_id = info_of_group.formMaster.id;

                teacher_block = document.querySelector(".info_one");

                teacher_block.setAttribute("onclick", "goToTeacher("+ teacher_id + ");");
